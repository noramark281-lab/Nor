...
// Dynamically loads the |EnableNonClientDpiScaling| from the User32 module. This
// API is only needed for PerMonitor V1 awareness mode.
...
class WindowClassRegistrar {
 public:
  ...
  // Unregisters the window class. Subclasses should call this method when
  // deleting their instance.
...
void WindowClassRegistrar::UnregisterWindowClass() {
  if (class_registered_ && g_active_window_count == 0) {
