    ...
    <div className="animate-in space-y-4 pb-20">
      ...
      <div className="row justify-between items-center" style={{ marginBottom: 12 }}>
        <div className="row gap-8 items-center">
          ...
          <button
            className="badge badge-accent row gap-4 items-center"
            style={{ cursor: 'pointer', background: 'rgba(240, 185, 11, 0.12)', border: '1px solid rgba(240, 185, 11, 0.25)' }}
            onClick={() => onNavigate('settings')}
            title="حالة المزامنة مع Firebase Cloud"
          >
            <Cloud size={11} className="text-accent" />
            <span style={{ fontSize: '10px' }}>Firebase Sync</span>
          </button>
        </div>
